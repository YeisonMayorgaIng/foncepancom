...
export default class ExploreBanner extends React.Component {
  ...
  animate() {
    ...
    if (x.matches) {
      if (dimensions.top - window.innerHeight < 0 && dimensions.bottom > 0) {
        ...
        this.image.current.style.transform = `translateY(${
          -scrolledRatio * 100
        }px)`;
      }
    }
  ...
  render() {
    return (
      <div className="pb-5 mb-5 explore-banner">
        <div
          className=" position-relative py-md-5"
          style={{
            fontWeight: '800 !important',
            color: 'yellow',
            backgroundColor: 'hsl(185deg 68% 7%)',
          }}
        >
          {/* Image Absolute */}
            ...
            <div className="row py-5">
              <div className="col-12 col-md-6 pb-5">
                <Link href="/collection">
                  <a className="d-flex py-3 align-items-center borderbottom">
                    <p
                      className="font-size-display3 font-color-white font-weight-normal mb-4"
                      style={{
                        maxWidth: '28rem',
                        'WebkitBackgroundClip': 'text',
                        'WebkitTextFillColor': 'transparent',
                        'backgroundImage':
                          'linear-gradient(to right,red, yellow, #229c2b,#229c2b)',
                        fontSize:'4rem'
                      }}
                    >
