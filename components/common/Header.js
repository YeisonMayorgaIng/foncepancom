  ...
  renderLoginLogout() {
    ...
    return (
      <div className="d-none d-sm-flex">
            <Link href="/branches">
              <a className="mr-4 font-color-black menu-animation">Establecimientos</a>
            </Link>
            <Link href="/contactUs">
              <a className="font-color-black menu-animation">Contáctenos</a>
            </Link>
    ...
    return (
      <header className="position-fixed top-0 left-0 right-0 font-weight-semibold no-print">
        ...
        >
          <div className="d-none d-sm-flex">
            <Link href="/">
              <a className="mr-4 font-color-black menu-animation">Inicio</a>
            </Link>
            <Link href="/about">
              <a className="font-color-black menu-animation">Nosotros</a>
            </Link>
          </div>
